...
class FinanceiroService {
  ...
  static const String s = '/financeiro';
  ...
  static Future<PaginaDto<FuncionarioDto>> getFuncionarios({
    ...
    String? cpf,
    String? telefone,
    String? tipoEspecializacao, // Enum convertido pra String
    int pagina = 0,
  }) async {
    final response = await _dio.get(
      '$s/funcionarios',
      queryParameters: {
        ...
        if (tipoEspecializacao != null && tipoEspecializacao.isNotEmpty)
  ...
  static Future<void> emitirTituloFuncionario(String id) async {
